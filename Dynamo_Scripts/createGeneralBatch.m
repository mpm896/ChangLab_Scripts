...
update line 137 with proper scaling factor. Otherwise comment out.

5. In line 140, update with the proper tableMap.doc file for your project
%}
...
o = dtcrop('PCR_tableMap.doc',tGlobal,pName,cropSize);
