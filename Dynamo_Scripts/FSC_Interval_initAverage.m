...
Matthew Martinez
Created 6/22/2020
Script for running FSC eveaverage_ref_001_ite_0006.emry n particles of a fimal average
...
rt = dread('allParticles_bin4_sym8/crop.tbl');
particleNum = size(rt,1); %number of rows of the refined table
rounds = ceil(particleNum/20);
...
for i = 1:rounds
    ...
    X = randperm(particleNum,20); %generates 300x1 table with random integers between 1 and particleNum
