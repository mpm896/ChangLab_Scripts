...
In this version, each particle is an individual parent model in ChimeraX
...
for i = 1:size(nTomo,1)
    ...
    if ~stat
        ...
        line1 = strcat('open',{' '},homeDir,'/temp_chimera_table.em');
        line2 = "volume #* level 6";
        line3 = strcat('open',{' '},path2posFile,{' '},'model #1-',string(volNum)); 
        line4 = "view orient";
        line5 = "color #* #30A6AD";
        line6 = "set bgColor white";
        lines2write = [];
        for k = 1:size(tCell{i},1)
            lines2write = [lines2write; line1];
        end
        lines2write = [lines2write; line2; line3; line4; line5; line6];
